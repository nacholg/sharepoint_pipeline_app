...
PROFILE_CONFIG = {
    ...
    "field_aliases": {
        ...
        "remarks": ["COMMENTS", "OBSERVATIONS", "OBSERVACIONES", "ADDITIONAL INFO"],
        "meals": ["REMARKS", "MEALS", "MEAL PLAN", "COMIDAS"],
        "food_restrictions": ["FOOD RESTRICTIONS","RESTRICTIONS" , "DIETARY RESTRICTIONS", "RESTREICCIONES ALIMENTARIAS"],
